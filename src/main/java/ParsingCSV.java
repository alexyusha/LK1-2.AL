...
public class ParsingCSV {
    ...
    protected static String checkNull(String str){
    ...
    protected static Set<InsuredPerson> getSetInsuredPerson(String...insuredPeople){
        Set<InsuredPerson> people = new HashSet<>();
    ...
    protected static Client getClient(String dataClient){
        Client client;
    ...
    protected static Calendar getDate(String date){
    ...
    /*public static final synchronized List<Object> deserialize(final String csv, final Class type, final Boolean hasHeaders) throws IOException{
        ...
        CsvSchema schema;
        if(hasHeaders){
            schema = csvMapper.schemaFor(type).withHeader();
        }
        else{
            schema = csvMapper.schemaFor(type).withoutHeader();
        }

        MappingIterator<Object> mappingIterator = csvMapper.readerFor(type).with(schema).readValues(csv);
